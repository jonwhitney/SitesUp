...
<body>
    <div class="reader">
    <table width="100%">
    <tr><th colspan="<?php echo $cols ?>">CDX Websites Health: <?php echo date("D, d M Y"); ?></th></tr>
    <tr>
        <td class="status"><?php echo ($numsites-$numprevsites) . " sites checked"?></td>
        <td class="statusok"><?php echo "Number ok: $num200"; ?></td>
        <td class="statusbad"><a onClick="openBad()"><?php echo "Number bad: " . (($numsites-$numprevsites)-$num200); ?></a></td>
